...
public class GameWorld extends World
{
    ...
    public void prepare()
    {
        Actor actor = (Actor) new LevelOne();
    ...
    public void workingOnit()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            { 
                if (count1 < 25)
                {
                    System.out.print(bitsList.get(count1).getClass().getSimpleName() + "[" +count1+"]    ");
                    count1++ ;
                }
       ...
       int count = 0;
        for (int i = 0; i < 5; i++)
        {
            ...
            { 
                if (count < 25)
                {
                    System.out.print(bitsList.get(count).getClass().getSimpleName() + "[" +count+"]    ");
                    count++ ;
                }
